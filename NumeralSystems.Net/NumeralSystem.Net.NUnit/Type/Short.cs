...
{
    [TestFixture]
    public class Short: IBaseTypeTest
    {
        ...
        {
            var number = (short)_random.Next();
            var int32 = new NumeralSystems.Net.Type.Base.Short(){ Value = number };
            Assert.That(number, Is.EqualTo(int32.Value));
            var fromBinary = new NumeralSystems.Net.Type.Base.Short()
            {
                Binary = int32.Binary
            };
            Assert.That(number, Is.EqualTo(fromBinary.Value));
            var fromBytes = new NumeralSystems.Net.Type.Base.Short()
            {
                Bytes = int32.Bytes
            };
        ...
        public void And()
        {
            var int32A = new NumeralSystems.Net.Type.Base.Short()
            {
                Value = (short)_random.Next()
            };
            var int32B = new NumeralSystems.Net.Type.Base.Short()
            {
                Value = (short)_random.Next()
            };
        ...
        public void Not()
        {
            var int32 = new NumeralSystems.Net.Type.Base.Short()
            {
                Value = (short)_random.Next()
            };
            Assert.That((short)~int32.Value, Is.EqualTo(int32.Not().Value));
        }
        ...
        public void Nand()
        {
            ...
            Assert.That((short)~(int32A.Value & int32B.Value), Is.EqualTo(int32A.Nand(int32B).Value));
        }
