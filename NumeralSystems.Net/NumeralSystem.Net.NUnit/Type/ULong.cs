...
{
    [TestFixture]
    public class ULong : IBaseTypeTest
    {
        ...
        {
            var number = (ulong)_random.Next();
            var int32 = new NumeralSystems.Net.Type.Base.ULong(){ Value = (ulong)number };
            Assert.That(number, Is.EqualTo(int32.Value));
            var fromBinary = new NumeralSystems.Net.Type.Base.ULong()
            {
                Binary = int32.Binary
            };
            Assert.That(number, Is.EqualTo(fromBinary.Value));
            var fromBytes = new NumeralSystems.Net.Type.Base.ULong()
            {
                Bytes = int32.Bytes
            };
        ...
        public void And()
        {
            var int32A = new NumeralSystems.Net.Type.Base.ULong()
            {
                Value = (ulong)_random.Next()
            };
            var int32B = new NumeralSystems.Net.Type.Base.ULong()
            {
                Value = (ulong)_random.Next()
            };
        ...
        public void Not()
        {
            var int32 = new NumeralSystems.Net.Type.Base.ULong()
            {
                Value = (ulong)_random.Next()
            };
