...
namespace NumeralSystems.Net
{
    ...
    /// </summary>
    public class NumeralValue : IComparable<NumeralValue>
    {
        /// <summary>
        ...
        /// </summary>
        public bool IsZero => Integral.All(x => x == 0) && Decimals.All(x => x == 0);
        ...
        private (BigInteger Numerator, BigInteger Denominator) ToRatio()
            => PositionalNotation.ToRatio(Integral, Decimals, Negative, Base);
            ...
            out bool exact)
        {
            ...
            var converted = PositionalNotation.FromRatio(
                numerator,
                denominator,
                baseValue,
                maxFractionalDigits);
