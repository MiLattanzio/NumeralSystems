...
{
    public class IncompleteShort : IIRregularOperable<IncompleteShort, Short, short>
    {
        ...
        public Short this[int value] => Short.FromBinary(value.ToBoolArray());

        public IEnumerable<Short> Enumerable => System.Linq.Enumerable.Range(0, Permutations).Select(x => this[x]);
