...
namespace NumeralSystens.Math.Net.Utils
{
    public static class Math
    {
        ...
        public static decimal And(this decimal a, decimal b) =>
            Convert.ToDecimal(And(Convert.ToBoolArray(a), Convert.ToBoolArray(b)));
        public static double And(this double a, double b) =>
            Convert.ToDouble(And(Convert.ToBoolArray(a), Convert.ToBoolArray(b)));
        public static float And(this float a, float b) =>
            Convert.ToFloat(And(Convert.ToBoolArray(a), Convert.ToBoolArray(b)));
